                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  msgBox(size, "Use the Stick on other hand Fandit", "08:20",Colors.blue.withOpacity(.1),Colors.black),
                                  const SizedBox(height: 30,),
                                  Align(
                                  ...
                                  const SizedBox(height: 30,),
                                  msgBox(size, "Morning!\n\nHow the result did it\nwork well", "08:20",Colors.blue.withOpacity(.1),Colors.black),
                                  const SizedBox(height: 30,),
                                  Align(
                                    alignment: Alignment.topRight,
                                    child:
                                  ...
                                  const Image(image: AssetImage('assets/images/emoji.png',),width: 30,height: 30,)
                                ],
                              ),
                            )),
                        Positioned(
